...
from app.api.routers.price_list import create, router, update
...
def test_create_price_list_requires_authentication_and_csrf() -> None:
...
def test_update_price_list_requires_authentication_and_csrf() -> None:
